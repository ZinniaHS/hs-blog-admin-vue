    ...
    <div class="table-container">
      <el-table :data="data.tableData" style="margin:5px;width: 100%"
        ...
        <el-table-column fixed="right" label="操作" min-width="150">
          <template #default="scope">
<!--            <el-button link type="primary" size="small" @click="dialogShowDetail=true;showDetail(scope.row.id)">Detail</el-button>-->
...
.el-table__body-wrapper {
  min-height: 300px; /* 保持表头可见 */
}

.pagination-wrapper {
  margin: 20px 0;
  display: flex;
  justify-content: center; /* 关键修改 */
  padding: 0 20px;
}
//.table{
//    // 边框阴影
